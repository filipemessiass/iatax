/**
 * ============================================
 * AGENT TAX CONSULT CLT - SCRIPT PRINCIPAL
...
(() => {
  ...
  const CONFIG = {
    agentId: 'clt', 
    agentName: 'Agente Tax - Consultor CLT',
    apiContext: 'CLT',
    // AJUSTE DE TEXTO: Corrigido e padronizado
    closingMessage: 'Conversa encerrada. Para um novo atendimento sobre CLT, selecione novamente o agente.'
  };
  ...
  function iniciarChat() {
    ...
    try {
      ...
      console.error('Erro ao inicializar o agente CLT:', erro);
      mostrarErroNoChat();
    }
  }
  ...
  function adicionarMensagemInicial() {
    ...
    const mensagemInicial = `Ol�! Eu sou o seu assistente para temas da <strong>CLT</strong>.
      <br><br>
      Posso apoiar com:
      <ul>
        <li>Contrata��o, jornada e banco de horas;</li>
        <li>C�lculo de f�rias, 13� e verbas rescis�rias;</li>
        <li>Pol�ticas internas, acordos e conven��es coletivas;</li>
        <li>Conformidade com eSocial, EFD-Reinf e auditorias internas;</li>
        <li>Preven��o de passivos trabalhistas e fiscaliza��es.</li>
      </ul>
      Como posso ajudar?`;
  ...
  function adicionarListenersCustomizados() {
    ...
    const placeholders = [
      'Descreva sua d�vida sobre CLT...',
      'Como funciona o banco de horas?',
      'Quais s�o as regras para f�rias?',
      'Como calcular uma rescis�o?'
    ];
  ...
  function adicionarMensagem(tipo, conteudo) {
    ...
    avatarIcon.className = tipo === 'bot' ? 'fa-solid fa-briefcase' : 'fa-solid fa-user';
  ...
  function mostrarIndicadorDigitacao() {
    ...
    avatarDiv.className = 'message-avatar';
    const avatarIcon = document.createElement('i');
    avatarIcon.className = 'fa-solid fa-briefcase';
    avatarDiv.appendChild(avatarIcon);
   ...
   * AJUSTE DE TEXTO: Respostas criadas para CLT.
   */
  function gerarRespostaBot(mensagem) {
    const texto = mensagem.toLowerCase();

    if (texto.includes('f�rias') || texto.includes('ferias')) {
      return `As **F�rias** (Art. 129 e 130 da CLT) s�o um direito do trabalhador ap�s 12 meses de contrato (per�odo aquisitivo).
      
      **Pontos principais:**
      <ul>
        <li>**Dura��o:** 30 dias corridos, se n�o houver mais de 5 faltas injustificadas.</li>
        <li>**Fracionamento:** Podem ser divididas em at� 3 per�odos, desde que um deles tenha no m�nimo 14 dias e os outros no m�nimo 5 dias cada (requer concord�ncia do empregado).</li>
        <li>**Pagamento:** O pagamento das f�rias (sal�rio + 1/3 constitucional) deve ser feito at� **2 dias antes** do in�cio do gozo.</li>
      </ul>`;
    }

    if (texto.includes('rescis�o') || texto.includes('demiss�o') || texto.includes('aviso pr�vio')) {
      return `O c�lculo da **Rescis�o** depende do tipo de desligamento:
      
      **1. Demiss�o sem Justa Causa:**
      <ul>
        <li>Aviso Pr�vio (trabalhado ou indenizado, 30 dias + 3 dias por ano trabalhado);</li>
        <li>Saldo de Sal�rio;</li>
        <li>13� Sal�rio Proporcional;</li>
        <li>F�rias Vencidas (se houver) + 1/3;</li>
      ...
      **2. Pedido de Demiss�o:**
      <ul>
        ...
        <li>F�rias Vencidas (se houver) + 1/3;</li>
        <li>F�rias Proporcionais + 1/3;</li>
        <li>**N�o** tem direito a saque do FGTS nem � multa de 40%.</li>
        <li>Se n�o cumprir o aviso pr�vio, o valor pode ser descontado.</li>
      </ul>`;
    }

    if (texto.includes('jornada') || texto.includes('banco de horas')) {
      return `A **Jornada de Trabalho** padr�o, segundo a CLT (Art. 58), � de **8 horas di�rias** e **44 horas semanais**.
      
      **Banco de Horas (Art. 59):**
      <ul>
        <li>Permite compensar horas extras com folgas ou redu��o de jornada.</li>
        <li>**Acordo Individual (T�cito ou Escrito):** Permite compensa��o dentro do mesmo m�s.</li>
        <li>**Acordo Individual (Escrito):** Permite compensa��o em at� 6 meses.</li>
        <li>**Acordo Coletivo (Sindicato):** Permite compensa��o em at� 1 ano.</li>
      </ul>
      � crucial ter um controle de ponto rigoroso para gerir o banco de horas.`;
    }

    // Resposta Padr�o (corrigida)
    return `Sou o assistente para temas da <strong>CLT</strong>.
      <br><br>
      Posso apoiar com:
      <ul>
        <li>Contrata��o, jornada e banco de horas;</li>
    ...
    erroDiv.innerHTML = `
      ...
      <div class="message-content">
        <div class="message-bubble" style="background: #FFFFFF; box-shadow: 0 12px 32px rgba(0, 0, 0, 0.06); border-color: #7AC143; color: #0F0F0F;">
          <strong>?? Erro ao iniciar o agente CLT</strong><br><br>

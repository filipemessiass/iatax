/**
 * ============================================
 * AGENT TAX CONSULT SPED FISCAL - SCRIPT PRINCIPAL
...
(() => {
  ...
  const CONFIG = {
    agentId: 'sped-fiscal',
    agentName: 'Agente Tax - Consultor SPED Fiscal',
    apiContext: 'SPED_FISCAL',
    // Mensagem usada ao fechar (retirada do .js original)
    closingMessage: 'Conversa encerrada. Para um novo atendimento sobre SPED Fiscal, selecione novamente o agente.'
  };
   ...
   * O conte�do foi retirado do 'agent_tax_sped_fiscal.html' original.
   */
  function adicionarMensagemInicial() {
    // Corrigimos a codifica��o
    const mensagemInicial = `Seja bem-vindo! Eu cuido do <strong>SPED Fiscal</strong>.
      <br><br>
      Posso ajudar com:
      <ul>
        <li>Blocos 0, C, D, E, G, H, K e registros de apura��o ICMS/IPI;</li>
        <li>Regras de substitui��o tribut�ria, diferen�as de al�quotas e antecipa��es;</li>
        <li>Invent�rios, controles de estoque e integração com Bloco K;</li>
        <li>Concilia��es com NF-e, CT-e, MDF-e e cruzamentos estaduais;</li>
        <li>Monitoramento de malhas fiscais, notifica��es e compliance.</li>
      </ul>
  ...
  function adicionarListenersCustomizados() {
    ...
    // *** CONTE�DO ADAPTADO PARA SPED FISCAL ***
    const placeholders = [
      'Descreva sua d�vida sobre SPED Fiscal...',
      'O que � o Bloco K (Estoque)?',
      'Como funciona o Bloco H (Invent�rio)?',
      'O que � o Registro E110 (Apura��o ICMS)?',
      'D�vidas sobre Substitui��o Tributária (ST)?'
    ];
  ...
  function adicionarMensagem(tipo, conteudo) {
    ...
    // *** �CONE ADAPTADO PARA SPED FISCAL ***
    avatarIcon.className = tipo === 'bot' ? 'fa-solid fa-folder-tree' : 'fa-solid fa-user';
  ...
  function mostrarIndicadorDigitacao() {
    ...
    avatarDiv.className = 'message-avatar';
    const avatarIcon = document.createElement('i');
    avatarIcon.className = 'fa-solid fa-folder-tree'; // �cone do SPED Fiscal
    avatarDiv.appendChild(avatarIcon);
   ...
   * uma resposta pr�-definida baseada nos t�picos do EFD ICMS/IPI.
   *
  ...
  function gerarRespostaBot(mensagem) {
    ...
    // T�pico 1: Bloco K (Estoque)
    if (texto.includes('bloco k') || (texto.includes('estoque') && !texto.includes('invent�rio'))) {
      return `O **Bloco K (Controle da Produ��o e do Estoque)** � uma das partes mais complexas do SPED Fiscal.
      
      **O que ele exige:**
      <ul>
        <li>**K200:** O estoque escriturado (saldo final) de cada produto no final do per�odo.</li>
        <li>**K230/K250:** O consumo de insumos na produ��o (o "input" da f�brica).</li>
        <li>**K235/K255:** Os produtos acabados/semi-acabados (o "output" da f�brica).</li>
      </ul>
      O Bloco K � obrigat�rio para muitas ind�strias e atacadistas, e o Fisco o utiliza para cruzar o que foi comprado (Entradas), o que foi produzido/consumido (K) e o que foi vendido (Sa�das).`;
    }

    // T�pico 2: Bloco H (Invent�rio)
    if (texto.includes('bloco h') || texto.includes('invent�rio')) {
      return `O **Bloco H (Invent�rio F�sico)** � obrigat�rio pelo menos uma vez por ano, geralmente no final do balan�o (Dezembro).
      
      **Pontos de aten��o:**
      <ul>
        <li>Deve conter a lista de **todos** os produtos em estoque (mat�ria-prima, produto acabado, insumos, etc.) na data do invent�rio.</li>
        <li>O **Motivo do Invent�rio** (Campo 02 do H005) � crucial:
            <ul>
                <li>**01:** No final do per�odo (Balan�o Anual).</li>
                <li>**02:** Na mudan�a de regime (ex: Simples para Presumido).</li>
                <li>**04:** Por solicita��o do Fisco.</li>
            </ul>
        </li>
        <li>O valor do Bloco H � cruzado com o Bloco K (se houver) e com a contabilidade (ECD).</li>
      </ul>`;
    }

    // T�pico 3: Bloco E (Apura��o) ou ST
    if (texto.includes('bloco e') || texto.includes('apura��o') || texto.includes('st') || texto.includes('substitui��o')) {
      return `O **Bloco E** � onde a m�gica da apura��o do ICMS e IPI acontece.
      
      <ul>
        <li>**Registro E100/E110 (ICMS):** Consolida todos os d�bitos (sa�das) e cr�ditos (entradas) dos Blocos C e D. O E110 � o "resumo" da apura��o, mostrando o ICMS a pagar ou saldo credor.</li>
        <li>**Registro E200/E210 (ICMS-ST):** Apura��o espec�fica da Substitui��o Tributária (ST) por estado (UF).</li>
        <li>**Registro E500/E520 (IPI):** Apura��o do IPI (para ind�strias).</li>
      </ul>
      Qualquer ajuste de apura��o (cr�dito presumido, estorno de d�bito, etc.) deve ser feito via **Registros E111 (ICMS)** ou **E530 (IPI)**.`;
    }

    // Resposta Padr�o (Fallback)
    // Se o bot n�o entender, ele se apresenta novamente.
    return `Seja bem-vindo! Eu cuido do <strong>SPED Fiscal</strong>.
      <br><br>
      Posso ajudar com:
      <ul>
        <li>Blocos K (Estoque), H (Invent�rio) e E (Apura��o);</li>
        <li>Regras de substitui��o tribut�ria (ST) e DIFAL;</li>
        <li>Concilia��es com NF-e e CT-e;</li>
        <li>Monitoramento de malhas fiscais.</li>
      </ul>
    ...
    erroDiv.innerHTML = `
      ...
      <div class="message-content">
        <div class="message-bubble" style="background: #FFFFFF; box-shadow: 0 12px 32px rgba(0, 0, 0, 0.06); border-color: #7AC143; color: #0F0F0F;">
          <strong>?? Erro ao iniciar o agente SPED Fiscal</strong><br><br>
